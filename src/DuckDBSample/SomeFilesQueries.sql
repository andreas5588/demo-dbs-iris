...
GO
THROUGH SERVER ExtSrv.DuckDB SELECT 1; CREATE VIEW Test1 AS SELECT * FROM read_csv('/opt/demodbsiris/src/DuckDBSample/data/airlines.dat');
GO
THROUGH SERVER ExtSrv.DuckDB SELECT 1; CREATE TABLE Test1 AS SELECT * FROM read_csv('/opt/demodbsiris/src/DuckDBSample/data/airlines.dat');
GO
